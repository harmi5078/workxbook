...
//主要城市
var cityesDataValue = dealWithData();
...
function createMap(divId)
{
	...
	myChart.on('click', function (params) {
		let [longitude, latitude] = myChart.convertFromPixel('geo',
       [params.event.offsetX, params.event.offsetY]);
       
       console.log("longitude:" + longitude)
       console.log("latitude:" + latitude)
       
       cityesDataValue.push({
	        value: [longitude, latitude, 16],
	        name: "点击位置"
	      })
...
{
	var cityShows2 = cityesDataValue.splice(0,5);
  	...
  	var option = {
	    series: [ 
	      { 
	        ...
	        coordinateSystem: "geo",
	        data: cityShows2,
	        symbol: "image://img//personred.svg",
	        symbolSize: 30,
	        tooltip: {
	          show: false
	        },
